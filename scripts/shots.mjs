...
await page.goto('http://localhost:4199/app/#/upload')
...
await page.goto('http://localhost:4199/app/#/controls')
await page.waitForTimeout(800)
await page.screenshot({ path: '/tmp/scf-shots/3-controls.png' })

await page.goto('http://localhost:4199/app/#/controls/GOV-01')
await page.waitForTimeout(600)
await page.screenshot({ path: '/tmp/scf-shots/4-detail.png' })

await page.goto('http://localhost:4199/app/#/crosswalk?fw=iso-27002-2022&fwB=emea-eu-nis2')
await page.waitForTimeout(800)
await page.screenshot({ path: '/tmp/scf-shots/5-crosswalk.png' })

await page.goto('http://localhost:4199/app/#/risks')
